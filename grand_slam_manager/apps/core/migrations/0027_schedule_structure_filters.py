"""Lectura filtrada de partidos para programacion."""
...
REVERSE_SQL = r"""
DROP FUNCTION IF EXISTS public.sp_schedule_matches_by_structure_json(integer, integer, integer, integer);
"""


class Migration(migrations.Migration):
    dependencies = [
        ("core", "0026_match_pairing_board_and_progression"),
    ]
