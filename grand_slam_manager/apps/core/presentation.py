...
PREFERRED_COLUMNS = {
    ...
    "Entry": ["torneo", "category_id", "categoria", "subcategory_id", "cuadro", "team_id", "equipo", "jugadores", "jugadores_inscritos", "seed", "ranking_at_entry", "draw_size", "available_slots"],
    ...
    "Team": ["name", "notes"],
    "TeamMember": ["equipo", "player_id", "jugador", "pais", "role", "start_date"],
